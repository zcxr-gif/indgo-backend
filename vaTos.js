...
const TOS_SUMMARY = [
    ...
    'Hosted website — you may build a public site in your Crew Center and we host it under one of our domains, at an address carrying your VA’s name. The content is yours and stays your responsibility; because it sits on our domain we can take one down, and hosting ends with your participation.',
...
const TOS_CHANGELOG = [
    {
        ...
        notes: [
            'Added: every participating VA may build a public website in its Crew Center and have us host it free of charge, at an address under one of our domains carrying your VA’s own name.',
